...
const CATEGORIES: Category[] = [
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        desc: 'Email + password, or otpVerified=true after OTP.',
        authType: 'none',
        body: '{\n  "email": "ada@example.com",\n  "password": "secret123"\n}',
      },
      {
        ...
        label: 'Send OTP code',
        desc: 'Email is temp-mail-checked + SMTP-probed (signup) before sending.',
        authType: 'none',
        body: '{\n  "email": "ada@example.com",\n  "purpose": "signup"\n}',
      },
      {
        ...
        desc: 'Returns a resetToken when purpose=reset.',
        authType: 'none',
        body: '{\n  "email": "ada@example.com",\n  "purpose": "signup",\n  "code": "123456"\n}',
      },
      {
        ...
        desc: 'Requires resetToken from verify-otp (purpose=reset).',
        authType: 'none',
