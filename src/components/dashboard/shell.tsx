    ...
    <div className="h-dvh flex flex-col overflow-hidden">
      <div className="flex flex-col lg:flex-row flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* h-dvh on the root bounds the height so main's overflow-y-auto
              actually scrolls. overscroll-contain stops pull-to-refresh from
              yanking the whole page when the list is scrolled to the top. */}
