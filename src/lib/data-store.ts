 ...
 * `onyxbase_*` key.
 *
 * The bootstrap key `onyxbase_xxxxxxxxxxxxxxxx` is hardcoded and cannot be revoked.
...
export interface AdminKeyRecord {
  id: string
  /** The full key string, e.g. `onyxbase_xxxxxxxxxxxxxxxx` or `onyxbase_a1b2c3...`. */
  key: string
...
export const BOOTSTRAP_ADMIN_KEY = 'onyxbase_xxxxxxxxxxxxxxxx'
